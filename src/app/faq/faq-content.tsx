...
export default function FaqContent() {
  ...
  const b2cFaqs = fr
    ? [
        ...
        { q: "Vos prix incluent-ils la douane ou les frais portuaires ?", a: "Oui, pour les envois B2C (personnels). Nos tarifs d'expédition B2C incluent les droits de douane, les frais de manutention portuaire et tous les frais liés à l'importation au Sénégal. Aucuns frais cachés — le prix affiché est le prix total. Remarque : pour les commandes en gros B2B, le dédouanement portuaire et les procédures douanières restent la responsabilité du client." },
        { q: "Puis-je expédier un véhicule au Sénégal ?", a: "Oui. Nous expédions les berlines pour 1 600 $ CAD et les VUS ou camions pour 1 700 $ CAD, aller simple. Les droits de douane et les frais portuaires sont inclus dans le tarif. Contactez-nous pour les exigences de préparation et la documentation nécessaire." },
    ...
    : [
        ...
        { q: "Do your prices include customs or port fees?", a: "Yes, for B2C (personal) shipments. Our B2C shipping rates include customs duties, port handling fees, and all import-related charges in Senegal. No hidden fees — the price you see is the total price. Note: for B2B wholesale orders, port clearance and customs procedures remain the client's responsibility." },
        { q: "Can I ship a vehicle to Senegal?", a: "Yes. We ship sedans for $1,600 CAD and SUVs or trucks for $1,700 CAD, one-way. Customs duties and port fees are included in the price. Contact us to discuss vehicle preparation requirements and documentation needed." },
  ...
  const b2bFaqs = fr
    ? [
        ...
        { q: "Les prix B2B incluent-ils les droits de douane ou les frais portuaires ?", a: "Non. Les tarifs B2B couvrent l'approvisionnement en produits et la coordination de l'exportation jusqu'au port au Sénégal. Les droits de douane, les frais de manutention portuaire et tous les frais liés à l'importation au Sénégal sont à la charge du client. Cela diffère de notre service B2C (personnel), où ces frais sont inclus dans le tarif d'expédition." },
        ...
        { q: "Que se passe-t-il une fois que mes marchandises arrivent au port au Sénégal ?", a: "ShipDirect livre au port. Une fois arrivé au port désigné, votre responsabilité commence — dédouanement, documentation d'importation, paiement des droits de douane et des frais portuaires, et transport vers votre installation de distribution." },
      ]
    : [
        ...
        { q: "Do B2B prices include customs duties or port fees?", a: "No. B2B rates cover product sourcing and export coordination up to port in Senegal. Customs duties, port handling fees, and all import-related charges in Senegal are the client's responsibility. This differs from our B2C (personal shipping) service, where these charges are included in the shipping rate." },
